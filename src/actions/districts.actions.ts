import { PRE_MERGER_DISTRICTS, PRE_MERGER_DISTRICTS_BY_CODE, PRE_MERGER_DISTRICTS_BY_ID, PRE_MERGER_DISTRICTS_BY_NAME, PRE_MERGER_DISTRICTS_BY_PROVINCE_CODE } from "../data/pre-merger-districts";
